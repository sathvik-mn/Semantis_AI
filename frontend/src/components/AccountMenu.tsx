                ...
                {loadingOpenAIStatus ? (
                  ...
                  <div>
                    ...
                    <div style={styles.infoBox}>
                      ...
                      <span style={{ fontSize: '12px' }}>Optional: Add your own OpenAI API key (starts with "sk-") for complete privacy. Without it, the server's shared key is used. This is NOT your Semantys API key — manage Semantys keys from the "API Keys" menu.</span>
                    </div>
                  </div>
                )}
              </div>

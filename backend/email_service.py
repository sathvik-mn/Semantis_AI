...
def send_welcome_email(to: str, name: str = "") -> bool:
    ...
    return _send(
        to=to,
        subject="Welcome to Semantys AI",
        html=f"""
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
            <h1 style="color: #7c3aed;">Welcome to Semantys AI!</h1>
            <p>Hi {display_name},</p>
            <p>Thanks for signing up! Semantys AI helps you save up to 70% on LLM API costs with intelligent semantic caching.</p>
            <h3>Quick Start:</h3>
            <ol>
                <li>Go to <a href="{FRONTEND_URL}/settings">Settings</a> to get your API key</li>
                <li>Replace your OpenAI base URL with your Semantys endpoint</li>
...
def send_usage_alert(to: str, plan: str, current_usage: int, max_usage: int) -> bool:
    ...
    return _send(
        to=to,
        subject=f"Semantys AI: You've used {pct}% of your {plan} plan",
        html=f"""
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
...
def send_api_key_created(to: str, key_prefix: str) -> bool:
    ...
    return _send(
        to=to,
        subject="Semantys AI: New API Key Created",
        html=f"""
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
...
def send_team_invite(to: str, inviter_name: str, org_name: str, invite_link: str) -> bool:
    ...
    return _send(
        to=to,
        subject=f"{inviter_name} invited you to {org_name} on Semantys AI",
        html=f"""
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #7c3aed;">You're Invited!</h2>
            <p><strong>{inviter_name}</strong> has invited you to join <strong>{org_name}</strong> on Semantys AI.</p>

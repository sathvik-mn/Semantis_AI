...
if (-not (Test-Path "dist\semantys_cache-1.0.0-py3-none-any.whl")) {
...
if ($continue -ne 's') {
    ...
    Write-Host "  pip install --index-url https://test.pypi.org/simple/ semantys-cache" -ForegroundColor White
    Write-Host ""
}
...
Write-Host "  - Package built: dist\semantys_cache-1.0.0-py3-none-any.whl" -ForegroundColor White
...
Write-Host "  3. Test install: pip install --index-url https://test.pypi.org/simple/ semantys-cache" -ForegroundColor White
Write-Host "  4. Verify on: https://test.pypi.org/project/semantys-cache/" -ForegroundColor White
